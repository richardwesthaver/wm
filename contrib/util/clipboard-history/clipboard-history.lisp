(in-package #:swm/clipboard-history)
...
(wm:add-wm-hook wm:*selection-notify-hook* 'swm/clipboard-history::save-clipboard-history)

(wm:defcommand show-clipboard-history () ()
  "Select from previously saved selections"
  (if (null *clipboard-history*)
      (wm:swm-message "No selection history")
      (let ((sel (second
                  (wm:select-from-menu
                   (wm:current-screen)
                   (mapcar (lambda (s)
